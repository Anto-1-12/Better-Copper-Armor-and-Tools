...
public class ModItems {
    ...
    public static final RegistryObject<Item> COPPER_HEART = ITEMS.register("copper_heart", () -> new HeartItem(new Item.Properties().tab(CreativeModeTab.TAB_FOOD), true));
    public static final RegistryObject<Item> REVERSED_COPPER_HEART = ITEMS.register("reversed_copper_heart", () -> new HeartItem(new Item.Properties().tab(CreativeModeTab.TAB_FOOD), false));
